...
function rolling(window_fn::F, data1::AbstractVector{T1}, window_span::Int, weights::AbstractVector{TW};
    ...
    elseif !padlast
        padded_rolling(data1, window_span, window_fn, weights; padding)
    else
        last_padded_rolling(data1, window_span, window_fn, weights; padding)
    end
end
...
function rolling(window_fn::F, data1::AbstractVector{T1}, data2::AbstractVector{T2}, window_span::Int, weights::AbstractVector{TW};
    ...
    elseif !padlast
        padded_rolling(data1, data2, window_span, window_fn, weights; padding)
    else
        last_padded_rolling(data1, data2, window_span, window_fn, weights; padding)
    end
end
...
function rolling(window_fn::F, data1::AbstractVector{T1}, data2::AbstractVector{T2}, data3::AbstractVector{T3}, window_span::Int, weights::AbstractVector{TW};
    ...
    elseif !padlast
        padded_rolling(data1, data2, data3, window_span, window_fn, weights; padding)
    else
        last_padded_rolling(data1, data2, data3, window_span, window_fn, weights; padding)
    end
end
...
function rolling(window_fn::F, data1::AbstractVector{T1}, data2::AbstractVector{T2}, data3::AbstractVector{T3}, data4::AbstractVector{T4},
    ...
    elseif !padlast
        padded_rolling(data1, data2, data3, data4, window_span, window_fn, weights; padding)
    else
        last_padded_rolling(data1, data2, data3, data4, window_span, window_fn, weights; padding)
    end
end
