...
function basic_tupled_rolling(func::Function, width::Span, data::TupleOfVectors)
    check_empty(data)
    ...
    nvalues = nrolling(minimum(map(length, data)), width)
...
function padfirst_tupled_rolling(func::Function, width::Span, data::TupleOfVectors, padding)
    check_empty(data)
    check_width(minimum(map(length, data)), width)
...
function padfinal_tupled_rolling(func::Function, width::Span, data::TupleOfVectors, padding)
    check_empty(data)
    check_width(minimum(map(length, data)), width)
...
function basic_tupled_rolling(func::Function, width::Span, data::TupleOfVectors, weights::TupleOfWeights)
    check_empty(data)
    check_empty(weights)
    check_width(minimum(map(length, data)), width)
...
function padfirst_tupled_rolling(func::Function, width::Span, data::TupleOfVectors, weights::TupleOfWeights, padding)
    check_empty(data)
    check_empty(weights)
    check_width(minimum(map(length, data)), width)
    check_weights(map(length, weights), width)
...
function padfinal_tupled_rolling(func::Function, width::Span, data::TupleOfVectors, weights::TupleOfWeights, padding)
    check_empty(data)
    check_empty(weights)
    check_width(minimum(map(length, data)), width)
    check_weights(map(length, weights), width)
