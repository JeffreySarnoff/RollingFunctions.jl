#=
     ...
     padded_rolling(window_fn::Function, ::Matrix, window_span, weights; padding, padfirst, padlast)
     last_padded_rolling(window_fn::Function, ::Matrix, window_span, weights; padding, padfirst, padlast)
=#
