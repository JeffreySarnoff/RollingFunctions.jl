...
function running(window_fn::F, window_span::Span,
    ...
    elseif !padlast
        padded_running(window_fn, window_span, datavec; padding)
    else
        last_padded_running(window_fn, window_span, datavec; padding)
    end
end
...
function running(window_fn::F, window_span::Span,
    ...
    elseif !padlast
        padded_running(window_fn, window_span, datavec, weightvec; padding)
    else
        last_padded_running(window_fn, window_span, datavec, weightvec; padding)
    end
end
...
function running(window_fn::F, window_span::Span,
    ...
    elseif !padlast
        padded_running(window_fn, window_span, datavec1, datavec2, weightvec; padding)
    else
        last_padded_running(window_fn, window_span, datavec1, datavec2, weightvec; padding)
    end
end
...
function running(window_fn::F, window_span::Span,
    ...
    elseif !padlast
        padded_running(window_fn, window_span, datavec1, datavec2, weightvec1, weightvec2; padding)
    else
        last_padded_running(window_fn, window_span, datavec1, datavec2, weightvec1, weightvec2; padding)
    end
end
...
function running(window_fn::F, window_span::Span,
    ...
    elseif !padlast
        ...
        last_padded_running(window_fn, window_span, data1, data2; padding)
    end
end
...
function running(window_fn::F, window_span::Span,
    ...
    elseif !padlast
        ...
        last_padded_running(window_fn, window_span, data1, data2, data; padding)
    end
end
...
function running(window_fn::F, window_span::Span,
    ...
    elseif !padlast
        padded_running_weighted(window_fn, window_span, data1, weights; padding)
    else
        last_padded_running_weighted(window_fn, window_span, data1, weights; padding)
    end
end
...
function running(window_fn::F, window_span::Span,
    ...
    elseif !padlast
        ...
        last_padded_running(window_fn, window_span, data1, weights; padding)
    end
end
...
function running(window_fn::F, window_span::Span,
    ...
    elseif !padlast
        ...
        last_padded_running(window_fn, window_span, data1, data2, weights; padding)
    end
end
...
function running(window_fn::F, window_span::Span,
    ...
    elseif !padlast
        padded_running(window_fn, window_span, data, weights; padding)
    else
        last_padded_running(window_fn, window_span, data, weights; padding)
    end
end
...
function running(window_fn::F, window_span::Span,
    ...
    elseif !padlast
        ...
        last_padded_running(window_fn, window_span, data1, data2, weights1, weights2; padding)
    end
end
...
function padded_running(window_fn::Function, window_span::Span,
                        data1::AbstractVector{T1}, data2::AbstractVector{T2};
    ...
    padded_running(window_fn, window_span, ᵛʷdata1, ᵛʷdata2; padding)
end
...
function last_padded_running(window_fn::Function, window_span::Int,
                             data1::AbstractVector{T1}, data2::AbstractVector{T2},
                             padding=nopadding) where {T1,T2}
    typ = promote_type(T1, T2)
    ᵛʷdata1 = typ == T1 ? asview(data1) : asview(map(typ, data1))
    ...
    last_padded_running(window_fn, window_span, ᵛʷdata1, ᵛʷdata2; padding)
end

#= !!FIXME!!
function last_padded_running(window_fn::Function, window_span::Span, data::DataVec;
         padding=nopadding)
...
function last_padded_running(window_fn::Function, data1::AbstractVector{T1}, data2::AbstractVector{T2},
    ...
    last_padded_running(window_fn, ᵛʷdata1, ᵛʷdata2, window_span,  ᵛʷweights1, ᵛʷweights2; padding)
end
...
function last_padded_running(window_fn::Function, data1::AbstractVector{T1}, data2::AbstractVector{T2}, data3::AbstractVector{T3},
    ...
    last_padded_running(window_fn, ᵛʷdata1, ᵛʷdata2, ᵛʷdata3, window_span, ᵛʷweights1, ᵛʷweights2, ᵛʷweights3; padding)
end
...
function last_padded_running(window_fn::Function, data1::AbstractVector{T1}, data2::AbstractVector{T2}, data3::AbstractVector{T3}, data4::AbstractVector{T4},
    ...
    last_padded_running(window_fn, ᵛʷdata1, ᵛʷdata2, ᵛʷdata3, ᵛʷdata4, window_span, ᵛʷweights1, ᵛʷweights2, ᵛʷweights3, ᵛʷweights4; padding)
end
