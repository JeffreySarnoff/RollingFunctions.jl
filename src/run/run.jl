...
function running(window_fn::F, data1::AbstractVector{T1}, data2::AbstractVector{T2}, window_span::Int,
    ...
    elseif !padlast
        ...
        last_padded_running(window_fn, data1, data2, window_span, weights1, weights2; padding)
    end
end
...
function running(window_fn::F, data1::AbstractVector{T1}, data2::AbstractVector{T2}, data3::AbstractVector{T3}, window_span::Int,
    ...
    elseif !padlast
        ...
        last_padded_running(window_fn, data1, data2, data3, window_span, weights1, weights2, weights3; padding)
    end
end
...
function running(window_fn::F, data1::AbstractVector{T1}, data2::AbstractVector{T2}, data3::AbstractVector{T3}, data4::AbstractVector{T4},
    ...
    elseif !padlast
        ...
        last_padded_running(window_fn, data1, data2, data3, data4, window_span, weights1, weights2, weights3, weights4; padding)
    end
end
