...
{{{
rolling{T}(fn::Function, filling::TypeFillFirst}, span::Int, data::Vector{T}) =
    rolling_fill_first(fn, span, data)

rolling{T}(fn::Function, filling::TypeFillLast}, span::Int, data::Vector{T}) =
    rolling_fill_last(fn, span, data)

rolling{T}(fn::Function, filling::TypeFillCenter}, span::Int, data::Vector{T}) =
