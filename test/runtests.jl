...
@test string(rolling_fill_first(mean, 4, NaN, fdata)) == string([NaN, NaN, NaN, 4.25, 5.5, 7.0])
@test string(rolling_fill_last(mean, 4, NaN, fdata)) == string([4.25, 5.5, 7.0, NaN, NaN, NaN])
